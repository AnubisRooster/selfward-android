...
This project is indexed by GitNexus as **selfward-android** (5382 symbols, 12148 relationships, 302 execution flows).
...
| Resource | Use for |
| --- | --- |
| `gitnexus://repo/selfward-android/context` | Codebase overview, check index freshness |
| `gitnexus://repo/selfward-android/clusters` | All functional areas |
| `gitnexus://repo/selfward-android/processes` | All execution flows |
| `gitnexus://repo/selfward-android/process/{name}` | Step-by-step execution trace |
