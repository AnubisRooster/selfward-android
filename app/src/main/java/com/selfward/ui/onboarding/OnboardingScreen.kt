...
private fun WelcomeStep() {
    Text("Welcome to Selfward", style = MaterialTheme.typography.headlineMedium)
    Text(
...
private fun DisclaimerStep(acknowledged: Boolean, onAcknowledge: (Boolean) -> Unit) {
    ...
    Text(
        "Selfward is not a licensed therapist, psychologist, or medical provider. " +
    ...
    Row(verticalAlignment = Alignment.CenterVertically) {
        ...
        Text(
            "I understand that Selfward is not a licensed therapist and is not a " +
...
private fun LocalModelStep() {
    ...
    Text(
        "Selfward can run a language model entirely on this device, with no API key " +
