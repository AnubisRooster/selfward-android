...
class MigrationTest {
    ...
    private fun openMigrated() = Room.databaseBuilder(context, SelfwardDatabase::class.java, dbName)
    ...
    fun aFreshInstallHasTheSameTablesAsAnUpgradedOne() {
        val db = Room.inMemoryDatabaseBuilder(context, SelfwardDatabase::class.java).build()
